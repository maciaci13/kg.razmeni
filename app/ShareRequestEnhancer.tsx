...
Ако и вие търсите размяна, влезте и подайте заявка. Колкото повече родители се включат, толкова по-голям шанс има да се появят реални съвпадения.`;
  ...
  overlay.innerHTML = `
    <div class="mzm-share-popup__panel" role="dialog" aria-modal="true" aria-label="Увеличи шанса за съвпадение">
      ...
      <p class="mzm-share-popup__text">
        Място За Място работи най-добре, когато повече родители подадат заявки. Сподели платформата в родителска група, твоят профил, вайбър или чат.
      </p>
