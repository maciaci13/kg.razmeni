...
const guides: Guide[] = [
  {
    ...
    title: "Как работи МястоЗаМясто",
    intro: "Бърз маршрут за родителите — от заявка до потенциална координация.",
    cards: [
      {
        tag: "01",
        title: "Настрой заявката",
        body: "Избери район, година, тип място, сегашна и желана градина. Данните се използват само за търсене на потенциален цикъл."
      },
      {
        tag: "02",
      ...
      {
        tag: "03",
        title: "Потвърди интерес",
        body: "При потенциално съвпадение всички участници трябва да потвърдят, преди да се отключи координация."
      },
      {
        tag: "04",
        title: "Пази личните данни",
        body: "Не споделяй документи, ЕГН, телефон или данни за детето в чата. Платформата е само за ориентация и контакт."
      }
    ],
    fullTitle: "Първи стъпки в МястоЗаМясто",
    sections: [
      {
      ...
      {
        title: "3. При match заявката се скрива",
        body: "Когато има потенциален цикъл, заявката се прибира, за да не създава шум. Участниците виждат покана за потвърждение."
      },
      {
        title: "4. Всички трябва да потвърдят",
        body: "Координацията се отключва само ако всички страни потвърдят интерес. Ако някой откаже, процесът се затваря и заявките могат да бъдат активирани отново."
      },
      {
        title: "5. Чатът е само за координация",
        body: "Чатът не заменя официален ред, заявление, административна процедура или решение на детска градина/община. Използвай го само за ориентация и уточняване дали другите родители реално имат интерес да продължат."
      }
    ],
    note: "МястоЗаМясто не гарантира преместване и не е официална система на Столична община, ИСОДЗ или детските градини."
  },
  {
    ...
    cards: [
      ...
      {
        tag: "04",
        title: "Решението не е в app-а",
        body: "Платформата помага на родители да се намерят. Тя не одобрява, не класира и не премества деца."
      }
    ],
    ...
    sections: [
      ...
      {
        title: "3. Не разчитай на устна уговорка",
        body: "Разговор между родители не създава право на преместване. Дори всички родители да са съгласни, реалният резултат зависи от официалната процедура и от компетентните институции."
      },
      {
        title: "4. Подай документи само по официален ред",
        body: "Документи, заявления, декларации и други данни се подават само през официално посочени канали. Не изпращай лични данни и документи през чата в платформата."
      },
      {
        title: "5. Отбележи резултата в системата",
        body: "Ако процесът приключи успешно или отпадне, отбележи статуса в МястоЗаМясто. Така системата няма да държи фалшиви активни маршрути."
      }
    ],
    note: "Този текст е практическа извадка и трябва да бъде финално сверена с актуалните официални правила преди публично пускане."
  }
];
