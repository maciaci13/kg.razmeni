...
function polishHeroActions(hero: HTMLElement) {
  ...
  buttons.forEach((button) => {
    ...
    if (text === "⌕" || text.includes("радар")) {
      button.classList.add("mzm-hero-radar-action");
      button.setAttribute("aria-label", "Радар за шанс");
      if (button.dataset.mzmHeroRadarBound !== "true") {
        button.dataset.mzmHeroRadarBound = "true";
