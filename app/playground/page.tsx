...
export default function PlaygroundPage() {
  ...
  const availableChats = useMemo(() => {
    if (!snapshot || !activeMatch || !selectedProfileId || !allConfirmed || matchIsClosed) return [];
  ...
  }, [snapshot, activeMatch, selectedProfileId, allConfirmed, matchIsClosed, participants.length]);
