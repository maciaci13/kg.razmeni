  ...
  return (
    <div className={`relative ${className}`}>
      <select
        ...
        className="w-full appearance-none rounded-2xl border-0 bg-paper py-4 pl-4 pr-12 text-sm font-black text-ink outline-none disabled:opacity-50"
      >
        {children}
      </select>
      <span className="pointer-events-none absolute right-5 top-1/2 -translate-y-1/2 text-base font-black leading-none text-ink/55">⌄</span>
    </div>
  );
}
